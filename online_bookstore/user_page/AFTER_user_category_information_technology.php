...
<body>
    ...
    <h1 class="heading_for_new_arrivel">INFORMATION TECHNOLOGY</h1>

    
    <selection class="features_c">
    
        
        <img class="features_a" src="images/information_technology.png">
    ...
    <div class="container">        
            <div class="box-container">
                ...
                ?>
                        ...
                        <?php
                        $sql = "SELECT * FROM addbook WHERE catogory='it'";
                        $result = $conn->query($sql);
                            ...
                            while ($row = $result->fetch_assoc()) 
                            {
                                ...
                                <a href="/online_bookstore/"  class="btn">ADD TO CART</a>
